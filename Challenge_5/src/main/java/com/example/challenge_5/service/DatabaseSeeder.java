...
import com.example.challenge_5.repositories.security.ClientRepository;
import com.example.challenge_5.repositories.security.RolePathRepository;
...
public class DatabaseSeeder implements ApplicationRunner {
    ...
    public void insertUser(String password) {
        for (String email: users) {
            ...
            String emailUser = str[0];
            String[] roleNames = str[1].split("\\s");

            User oldUser = userRepository.findOneByEmail(emailUser);
            if (null == oldUser) {
                oldUser = new User();
                oldUser.setEmail(emailUser);
